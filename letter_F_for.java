/*Programa em Java com estrutura de repetição "For" que apresenta como resultado o valor de uma potência de uma base qualquer elevada a um expoente qualquer, ou seja, de B^E, em que B é o valor da base e E o valor do expoente. Neste programa não se pode ser utilizado o operador de exponenciação do portuguol (^).*/
...
class letter_F_for{
  public static void main(){
    ...
    double base, exponent, count, counter, pass = 0;
    String condition;

     System.out.println("\n====== Estrutura 'FOR' - Base qualquer elevada a expoente qualquer ======");
