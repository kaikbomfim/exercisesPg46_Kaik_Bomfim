...
class letter_K_for{
  public static void main(){
    ...
    double width, length, area, totalArea = 0, counter, pass = 0;

    String roomName, condition;

    System.out.println("\n====== Estrutura 'FOR' - Cálculo de área dos cômodos da casa ======\n");
